...
const double kDefaultUpperFrequencyLimit = 7600;
const double kDefaultLowerFrequencyLimit = 80;
const double kFilterbankFloor = 1e-6;
const int kDefaultFilterbankChannelCount = 64;
const int kDefaultDCTCoefficientCount = 40;
